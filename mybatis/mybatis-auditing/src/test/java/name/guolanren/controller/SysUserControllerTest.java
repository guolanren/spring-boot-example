...
public class SysUserControllerTest {
    ...
    public void whenCreateSuccess() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/sys_user")
    ...
    public void whenModifySuccess() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/sys_user")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content(content))
                .andExpect(MockMvcResultMatchers.status().isOk());

        mockMvc.perform(MockMvcRequestBuilders.get("/sys_user/1")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .content(content))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.gmtCreate").exists())
